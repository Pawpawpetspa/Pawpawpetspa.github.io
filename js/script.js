    ...
    $(function () {
        ...
        function initOwlCarousel(c) {
            ...
            c.owlCarousel({
                ...
                autoplayTimeout: c.attr("data-autoplay-speed")
                    ? parseInt(c.attr("data-autoplay-speed"))
                    : 3500,
                                    ...
                                    var isValidated = (function () {
                                        ...
                                        if (elements.length) {
                                            ...
                                            if (captcha) {
                                                if (captcha.length) {
                                                    return (
                                                        validateReCaptcha(captcha) && errors === 0
                                                    );
                                                }
                                            }
                    ...
                    beforeSubmit: function (arr, $form, options) {
                        ...
                        if (isValidated(inputs, captcha)) {
                            ...
                            setTimeout(function () {
                                ...
                                output.html(
                                    '<p><span class="icon text-middle mdi mdi-check icon-xxs"></span><span>Sent!</span></p>'
                                );
                            }, 1000);
        ...
        if (plugins.multitoggles.length) {
            for (var i = 0; i < plugins.multitoggles.length; i++) {
                var node = plugins.multitoggles[i],
                    toggle = new Toggle({
                        node: node,
        ...
        function transformView(element) {
            ...
            if (
                window.scrollY > elementTop + window.scrollY || // target not below
                window.scrollY < elementTop + window.scrollY + elementHeight
            ) {
                // target not above
                // Ratio between visible part and already scrolled [0; 1]
                var visiblePartRatio = (
                    1 -
                    (elementHeight - Math.abs(elementTop)) / elementHeight
                ).toFixed(2);
